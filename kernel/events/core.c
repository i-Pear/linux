...
DEFINE_STATIC_CALL_RET0(__perf_guest_get_fp, *perf_guest_cbs->get_fp);
...
void perf_register_guest_info_callbacks(struct perf_guest_info_callbacks *cbs)
{
	...
	static_call_update(__perf_guest_get_fp, cbs->get_fp);
...
void perf_unregister_guest_info_callbacks(struct perf_guest_info_callbacks *cbs)
{
	...
	static_call_update(__perf_guest_get_fp, (void *)&__static_call_return0);
